...
function calc_dipole_matrix_element(param, spstates, n₁, n₂, M)
    ...
    for l₂ in 0:lmax, j₂ in 2l₂+1: -2: max(2l₂-1,0)
        ...
        for l₁ in 0:lmax, j₁ in 2l₁+1: -2: max(2l₁-1,0)
            ...
            ME_rad = 0.0
            for ir in 1:Nr 
                ME_rad += rs[ir] * ψs[ir, n₁_lj, i₁] * ψs[ir, n₂_lj, i₂]
            end
        ...
        for n₃ in 1:n₄-1 # n₃ < n₄
            ...
            for n₂ in 1:2nstates 
                ...
                for n₁ in 1:n₂-1 # n₁ < n₂
                    ...
                    if n₂ === n₄ 
                        BE1 += coeff_excited[n₁₂] * coeff_gs[n₃₄] * 
...
function test_calc_BE1_strength(param; β=0.0, howmany=10, Γ=0.2, Emax=10.0)
